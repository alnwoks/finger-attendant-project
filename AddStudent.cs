    ...
    public partial class AddStudent : Form
    {
        ...
        private void AddVoter_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataAdapter da2 = new SqlDataAdapter("Select max(sid) from Stud", con);
            ...
            //int s;
            //SqlDataAdapter da = new SqlDataAdapter("Select max(sid) from Stud", con);
            ...
            if (textBox1.Text != "")
            {
                ...
                if (iError == (Int32)SGFPMError.ERROR_NONE)
                {
                    ...
                    if (iError == (Int32)SGFPMError.ERROR_NONE)
                    {
                        ...
                        int total = 50000;
                        int pending = total-Convert.ToInt32(txtpaid.Text);
                        label6.Text = Convert.ToString(pending);
                        if(pending==0)
                        {
                            label7.Text = "paid";
                        }
                        ...
                        SqlCommand cmd = new SqlCommand("Insert into Stud (sid,name,mobile,address,image,template,class,total,pending,status) Values ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + @"Image\" + textBox1.Text + ".jpg" + "',@data,'"+comboBox1.Text+"','"+txttotal.Text+"','"+label6.Text+ "','" + label7.Text + "')", con);
                        con.Open();
                        cmd.Parameters.AddWithValue("@data", fp_image);
                        cmd.ExecuteNonQuery();
                        label6.Text = "";
                        con.Close();
                        DialogResult d = MessageBox.Show("Student Registred Successfully", "Successfull", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            updatesudent frm2 = new updatesudent();
            frm2.Show();
        }
