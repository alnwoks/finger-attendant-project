    ...
    public partial class Attendance : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (id != "")
                {
                    SqlCommand cmd = new SqlCommand("Select Name,Image from Stud where SId='" + id + "'", con);
                    con.Open();
                    ...
                    cmd = new SqlCommand("Select * from Atten where SId ='" + textBox1.Text + "' AND Date ='" + textBox4.Text + "' AND Class = '" + comboBox5.Text + "' ", con);
                    con.Open();
                    dr = cmd.ExecuteReader();
                    if (dr.HasRows)
                    {
                        con.Close();
                        DialogResult d = MessageBox.Show("You Gave Already Gave Your Attendance", "Error !!!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    {
                        con.Close();
                        cmd = new SqlCommand("Insert into Atten values ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox4.Text + "','" + comboBox5.Text + "')", con);
                        con.Open();
                        cmd.ExecuteNonQuery();
                        con.Close();
                        DialogResult d = MessageBox.Show("Attendance Marked Successfully", "Successfully !!!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        if (d == DialogResult.OK)
                        {
                            textBox1.Text = "";
                            textBox2.Text = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("You have already given your attendance ", "multiple attendance is  not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                string vote = ",'0','0','0','0'";
